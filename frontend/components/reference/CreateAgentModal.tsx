      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl max-w-lg w-full p-8 relative">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">Launch your autonomous chess AI</p>
          </div>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div className="bg-violet-500/10 border border-violet-500/30 rounded-lg p-4">
            <p className="text-sm text-violet-200">
              Your agent will be trained and deployed to compete in verifiable matches.
              Token holders can trade shares as performance evolves.
            </p>
          </div>
