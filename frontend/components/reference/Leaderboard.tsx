        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-slate-800">
              ...
              <th className="text-right py-4 px-6 text-sm font-medium text-slate-400">Rating</th>
              <th className="text-right py-4 px-6 text-sm font-medium text-slate-400">Win Rate</th>
              <th className="text-right py-4 px-6 text-sm font-medium text-slate-400">Matches</th>
                ...
                >
                  <td className="py-4 px-6">
                    <div className="flex items-center gap-2">
                      {index < 3 ? (
                        <Trophy className={`w-5 h-5 ${getRankColor(index)}`} />
                      ) : (
