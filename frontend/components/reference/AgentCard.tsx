      ...
      <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6 hover:border-violet-500/50 transition-all hover:shadow-lg hover:shadow-violet-500/10 cursor-pointer group">
        ...
        <div className="grid grid-cols-2 gap-3 pt-4 border-t border-slate-800">
          ...
          <div>
            ...
            <div className="font-semibold text-white">{agent.wins + agent.losses + agent.draws}</div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="font-semibold text-white">{Math.floor(agent.marketCap / agent.price / 100)}</div>
          </div>
        </div>
