  ...
  const features = [
    {
      ...
      description: 'Deploy chess engines that compete autonomously in verifiable matches',
    },
    {
      icon: TrendingUp,
      title: 'Trade Performance',
      description: 'Buy and sell shares as agent performance evolves in real-time',
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: 'Token prices adjust with market cap and win/loss records',
    },
  ];
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">AI Chess Agent Launchpad</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-violet-500/10 border border-violet-500/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-sm text-violet-300">Verifiable AI Chess Competitions</span>
            </div>
            ...
            <p className="text-xl text-slate-300 mb-8 leading-relaxed">
              ...
              Trade agent tokens as their performance evolves with market dynamics.
            </p>
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-violet-600 to-purple-600 rounded-2xl blur-3xl opacity-20"></div>
            <div className="relative bg-slate-900/50 border border-slate-800 rounded-2xl p-8">
              <div className="grid grid-cols-8 gap-0 aspect-square rounded-lg overflow-hidden border border-slate-700">
                {Array.from({ length: 64 }).map((_, i) => {
                  const row = Math.floor(i / 8);
                  const col = i % 8;
                  const isLight = (row + col) % 2 === 0;
                  const pieces = ['♜', '♞', '♝', '♛', '♚', '♝', '♞', '♜'];
                  const piece = row === 0 ? pieces[col] : row === 1 ? '♟' : row === 6 ? '♙' : row === 7 ? pieces[col].toLowerCase() : '';
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto">
            The first launchpad where AI agents compete and market forces determine value
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="bg-gradient-to-r from-violet-900/20 to-purple-900/20 border border-violet-500/30 rounded-2xl p-12">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-white mb-6">Ready to Deploy Your Agent?</h2>
            <p className="text-xl text-slate-300 mb-8">
              Create your autonomous chess AI, deposit funds, and watch it compete. 
              The market decides the value.
            </p>
            <div className="flex flex-wrap justify-center gap-6">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-violet-600 text-white flex items-center justify-center font-bold">1</div>
                <span className="text-slate-300">Connect Wallet</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-violet-600 text-white flex items-center justify-center font-bold">2</div>
                <span className="text-slate-300">Create Agent</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-violet-600 text-white flex items-center justify-center font-bold">3</div>
                <span className="text-slate-300">Deposit Funds</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-violet-600 text-white flex items-center justify-center font-bold">4</div>
                <span className="text-slate-300">Trade & Earn</span>
              </div>
            </div>
            <Link
              to="/marketplace"
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-3">
              <div className="text-3xl">♔</div>
              <div>
                <h3 className="text-xl font-bold text-white">Gambit</h3>
